# app/services/openai_answer_generator.py
...
def generate_answer_openai(context_chunks: list[str], question: str, model: str = "gpt-3.5-turbo") -> str:
    """
    Generates an answer to a question based on provided context chunks using OpenAI.
...
"""
    ...
    # Initialize the OpenAI client and generate the answer
    try:
        client = get_openai_client()
        answer = client.generate_completion(prompt, model=model, temperature=0.3)
        return answer
    except Exception as e:
